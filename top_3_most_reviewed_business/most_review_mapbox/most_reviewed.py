...
def main(business, output):
    ...
    #result = catering.sort(catering['review_count'].desc())

    # group by city/state list first 3
    #result = result.limit(10).withColumn("city/state", functions.lit("all/all"))
...
if __name__ == '__main__':
    business = sys.argv[1]
    output = sys.argv[2]
    spark = SparkSession.builder.appName('most review df').getOrCreate()
